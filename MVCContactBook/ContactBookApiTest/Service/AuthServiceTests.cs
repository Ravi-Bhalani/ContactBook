...
namespace ContactBookApiTest.Service
{
    public class AuthServiceTests
    {
        ...
        public void GetUserById_ReturnsUser_WhenUserExists()
        {
            ...
            var mockAuthRepository = new Mock<IAuthRepository>();
            var mockConfiguration = new Mock<IPasswordService>();
            mockAuthRepository.Setup(r => r.GetUseById(loginId)).Returns(existingUser);
            var target = new AuthService(mockAuthRepository.Object, mockConfiguration.Object);

            

            // Act
            var actual = target.GetUserById(loginId);
            ...
            mockAuthRepository.Verify(r => r.GetUseById(loginId), Times.Once);
        }
        [Fact]
        public void GetUserById_ReturnsFailureMessage_WhenUserDoesNotExist()
        {
            ...
            mockAuthRepository.Setup(r => r.GetUseById(loginId)).Returns(nullUser);
        ...
        public void ModifyUser_UserExists_UpdateSuccessful()
        {
            ...
            var mockAuthRepository = new Mock<IAuthRepository>();
            var mockConfiguration = new Mock<IPasswordService>();
            mockAuthRepository.Setup(r => r.UserExist(updateDto.LoginId, updateDto.Email, updateDto.userId)).Returns(false);
            mockAuthRepository.Setup(r => r.GetUseById(updateDto.LoginId)).Returns(new User()); // Return a non-null user
            mockAuthRepository.Setup(r => r.UpdateUser(It.IsAny<User>())).Returns(true);

            var target = new AuthService(mockAuthRepository.Object, mockConfiguration.Object);

            // Act
            var actual = target.ModifyUser(updateDto);

            // Assert
            Assert.True(actual.Success);
            Assert.Equal("User updated successfully.", actual.Message);

            mockAuthRepository.Verify(r => r.UserExist(updateDto.LoginId, updateDto.Email, updateDto.userId), Times.Once);
            mockAuthRepository.Verify(r => r.GetUseById(updateDto.LoginId), Times.Once);
        ...
        public void ModifyUser_UserDoesNotExist()
        {
            ...
            var mockAuthRepository = new Mock<IAuthRepository>();
            var mockConfiguration = new Mock<IPasswordService>();
            mockAuthRepository.Setup(r => r.UserExist(updateDto.LoginId, updateDto.Email, updateDto.userId)).Returns(false); // Simulate user does not exist
            mockAuthRepository.Setup(r => r.GetUseById(updateDto.LoginId)).Returns((User)null); // Return null for non-existing user
        ...
        public void ModifyUser_UserAlreadyExists()
        {
            ...
            var mockAuthRepository = new Mock<IAuthRepository>();
            var mockConfiguration = new Mock<IPasswordService>();
            mockAuthRepository.Setup(r => r.UserExist(updateDto.LoginId, updateDto.Email, updateDto.userId)).Returns(true); // Simulate user already exists
            ...
            mockAuthRepository.Verify(r => r.UserExist(updateDto.LoginId, updateDto.Email, updateDto.userId), Times.Once);
            mockAuthRepository.Verify(r => r.GetUseById(updateDto.LoginId), Times.Never); // GetUseById should not be called
            mockAuthRepository.Verify(r => r.UpdateUser(It.IsAny<User>()), Times.Never); // UpdateUser should not be called
        }
