...
namespace ContactBookApi.Services.Implementation
{
    public class ContactService : IContactService
    {
        ...
        public ServiceResponse<IEnumerable<ContactSPDto>> GETCONTACTBYBIRTHDATEMONTH(int month)
        {
            ...
            var contacts = _contactRepository.GETCONTACTBYBIRTHDATEMONTH(month);
        ...
        {
            var response = new ServiceResponse<IEnumerable<ContactSPDto>>();
            var contacts = _contactRepository.GETCONTACTBYSTATE(stateId);
        ...
        public ServiceResponse<IEnumerable<ContactDto>> GetPaginatedContacts(int page, int pageSize, string? letter,string sortOrder,string search)
        {
            var response = new ServiceResponse<IEnumerable<ContactDto>>();
        ...
        {
            var response = new ServiceResponse<IEnumerable<ContactDto>>();
            var contacts = _contactRepository.GetFavouritePaginatedContacts(page, pageSize, letter);
        ...
        public ServiceResponse<string> AddContact(ContactBook contact)
        {
            ...
            {
                response.Success = false;
                response.Message = "Birthdate cannot be a future date";
                return response;
            }
        ...
        public ServiceResponse<string> ModifyContact(ContactBook contact)
        {
            ...
            if (existingContact != null)
            {
                ...
                //existingContact.Country = new Country()
                //{
                //    CountryId = contact.Country.CountryId,
                //    CountryName = contact.Country.CountryName
                //};
                //existingContact.State = new State()
                //{
                //    StateId = contact.State.StateId,
                //    StateName = contact.State.StateName
                //};
